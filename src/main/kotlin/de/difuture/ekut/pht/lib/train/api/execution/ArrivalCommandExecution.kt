 ...
 *
 */
interface ArrivalCommandExecution<A, B : ITrainArrival, C : IRuntimeClient, D: Supplier<A>> : CommandExecution<A> {
 ...
 */
typealias DockerArrivalExecution<A, B> = ArrivalCommandExecution<A, B, IDockerClient, DockerOutputSupplier<A>>
