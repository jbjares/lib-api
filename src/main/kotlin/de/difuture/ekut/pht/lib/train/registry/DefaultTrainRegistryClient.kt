...
class DefaultTrainRegistryClient(
    ...
    override fun listTrainArrivals() =
            dockerRegistryClient
                    // for each repository that the Docker Registry offers
                    .listRepositories()
                    // for each of the tags that can be found in the repository
                    .flatMap { repo ->
    ...
    override fun listTrainArrivals(tag: ITrainTag): List<ITrainArrival> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun listTrainArrivals(id: ITrainId): List<ITrainArrival> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun getTrainArrival(id: ITrainId, tag: ITrainTag): ITrainArrival? {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun hasTrainArrival(id: ITrainId, tag: ITrainTag): Boolean {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun push(departure: ITrainDeparture<IDockerClient>) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
}
