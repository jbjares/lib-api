...
object RunAlgorithm : DockerArrivalExecution<RunAlgorithmResponseContent, DockerRegistryTrainArrival> {
    ...
    override fun execArrival(interf: DockerRegistryTrainArrival, client: DockerRuntimeClient, info: StationInfo) =
            execute<RunAlgorithmResponseContent>(interf, this.command, client, info)
}
